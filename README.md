...
```groovy
plugins {
    id "com.bakdata.gradle.davimc24.avro" version "VERSION"
}
```
...
In this case, use the `com.bakdata.gradle.davimc24.avro-base` plugin instead, and create tasks of type `GenerateAvroJavaTask` and/or `GenerateAvroProtocolTask`.
...
apply plugin: "java"
apply plugin: "com.bakdata.gradle.davimc24.avro-base"
